<template>
  <section class="text-gray-700 bg-white body-font">
    ...
    >
      <a
        href="#_"
        class="font-sans flex text-l justyfy-center sm:justify-start items-center gap-2 font-black leading-none text-gray-900 hover:text-indigo-600 select-none logo"
      ...
      >
        <a href="https://www.linkedin.com/company/cadandcodes" class="text-gray-500 hover:text-gray-800" target="_blank">
        ...
        <a href="#" class="text-gray-500 hover:text-gray-800" target="_blank">
        ...
        <a href="https://github.com/cadandcodes" class="text-gray-500 hover:text-gray-800" target="_blank">
