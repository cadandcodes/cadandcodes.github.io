<template>
  <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl lg:max-w-4xl overflow-hidden relative">
      ...
      <div
        class="testimonials flex space-x-12"
        @mouseover="pauseAnimation"
        @mouseleave="resumeAnimation"
        :style="{ animationDuration: `${testimonials.length * 5}s`, animationPlayState: animationState }"
      >
        <!-- Testimonial Items -->
        <div
        ...
        >
          <img class="mx-auto h-12" :src="testimonial.logo" alt="" />
          <blockquote class="mt-10 text-xl/8 font-semibold text-gray-900 sm:text-2xl/9">
  ...
  data() {
    return {
      ...
      testimonials: [
        ...
        {
          logo: "https://tailwindui.com/plus/img/logos/tuple-logo-indigo-600.svg",
        ...
        {
          logo: "https://tailwindui.com/plus/img/logos/level-logo-indigo-600.svg",
